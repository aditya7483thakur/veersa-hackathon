...
const RegisterScreen = () => {
  ...
  return (
    <ScrollView className=" w-full" style={{ backgroundColor: Colors.bgWhite(1) }} contentContainerStyle={{
    flexGrow: 1,
    ...
    padding: 20,
      ...
      <TextInput
        ...
        editable={!loading}
        style={{ borderColor: errors.name ? 'rgba(239, 68, 68, 1)' : 'rgba(209, 213, 219, 1)' }} // red-500 or gray-300 in rgba
      />
      ...
      <TextInput
        ...
        editable={!loading}
        style={{ borderColor: errors.email ? 'rgba(239, 68, 68, 1)' : 'rgba(209, 213, 219, 1)' }}
      />
      ...
      <TextInput
        ...
        editable={!loading}
        style={{ borderColor: errors.password ? 'rgba(239, 68, 68, 1)' : 'rgba(209, 213, 219, 1)' }}
      />
      ...
      <TextInput
        ...
        editable={!loading}
        style={{ borderColor: errors.role ? 'rgba(239, 68, 68, 1)' : 'rgba(209, 213, 219, 1)' }}
      />
      {errors.role && <Text className="text-red-500 text-sm mb-2">{errors.role}</Text>}

      <TouchableOpacity
        className="rounded-lg p-4 mt-4"
        style={{
          backgroundColor: loading ? 'rgba(156, 163, 175, 1)' : Colors.bgColor(1), // gray-400 or your bgColor
        }}
